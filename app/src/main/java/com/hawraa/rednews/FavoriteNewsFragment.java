...
public class FavoriteNewsFragment extends Fragment implements NewsAdapter.OnNewsAdapterClickListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_favorite_news, container, false);
        ...
        viewModel.getFavorite().observe(this, new Observer<List<NewsModel>>() {
            ...
            public void onChanged(@Nullable List<NewsModel> mNewsList) {
                if(mFavoriteNewsList != null) {
                    mFavoriteNewsList.clear();
                }
                mFavoriteNewsList= mNewsList;
                setRecyclerView();
